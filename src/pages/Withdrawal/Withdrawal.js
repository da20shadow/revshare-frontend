                    ...
                    <div className="px-4 py-6 sm:px-0">
                        <div className="h-fit">
                            ...
                            <form className={'my-5 border border-gray-300 bg-gray-200 px-10 py-10 shadow-xl w-full md:w-1/2 mx-auto border border-sky-100 rounded-lg'}>
                                ...
                                <h3 className={'mb-3 text-xl text-center text-rose-700'}>Min Withdrawal: <strong>$50</strong></h3>
                                ...
                                <div className={'mt-4 flex justify-between'}>
                                    <button className={'text-white font-bold bg-gradient-to-r from-orange-400 to-orange-600 text-xl px-10 py-2 border hover:shadow-lg rounded-lg'} type={'submit'}>Withdrawal</button>
                                </div>
